...
enum enMainMenueList { ShowClientList = 1, AddNewClient, DeleteClient, UpdateClientInfo, FindClient, TransactionsMenue, Exit };
enum enTransactionMenue{Deposit=1,Withdraw,TotalBalances,MainMenue};
