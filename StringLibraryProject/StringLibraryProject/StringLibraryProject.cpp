...

{
    ...
    cout << "Number of words: " << String1.CountWords("Hello, How are you?") << endl;

    cout << "Number of words: " <<
        clsString::CountWords("Hassan Mohamed Ahmed") << endl;
    ...
    cout << "Capital Letters count : " << clsString::CountLetters("Abdelrhman Fawzy", clsString::CapitalLetters) << endl << endl;
    ...
    //Tirms
    String3.Value = "    Abdelrhman Fawzy     ";
    ...
    String3.Value = "Hassan Mohamed Ahmed";
    cout << "\n\nString     = " << String3.Value;
